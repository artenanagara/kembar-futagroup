...
export const cmsArticles: Article[] = [
  {
    ...
    content: 'Program beautifikasi Stasiun Klaten menjadi salah satu proyek yang paling dekat dengan rumah bagi Kembar Futagroup. Melalui unit usahanya, grup memasok produk-produk yang kini menyambut penumpang di area stasiun, mulai dari bollard pembatas, kursi tunggu, hingga tanaman penghijau.\n\nKolaborasi antarunit menjadi kunci. Elemen cor logam dikerjakan lini pengecoran dan fabrikasi grup, sementara elemen hijau disiapkan oleh Futafarm.',
  ...
  },
  {
    ...
    title: 'ISO 14001, ISO 45001, hingga TKDN: Kredensial Mutu Unit Usaha',
    ...
    content: 'Sebagai bagian dari komitmen menjaga mutu produk, unit usaha Kembar Futagroup mengantongi sertifikasi ISO 14001:2015 untuk manajemen lingkungan dan ISO 45001 untuk keselamatan dan kesehatan kerja.\n\nSelain itu, produk grup telah tersertifikasi TKDN dan terdaftar sebagai penyedia di e-Katalog LKPP.',
    metaTitle: 'Sertifikasi Mutu Produksi Kembar Futagroup',
    metaDescription: 'Kredensial mutu unit usaha Kembar Futagroup mencakup ISO 14001, ISO 45001, TKDN, dan e-Katalog LKPP.',
