  ...
  >
    <div class="mx-auto flex min-h-130 max-w-7xl flex-col items-center justify-center px-5 py-28 text-center sm:px-8 lg:px-25 lg:py-34">
      <div
        ...
        data-reveal-item
      >
        <h2 class="mx-auto max-w-340 text-5xl font-normal leading-[1.08] tracking-normal text-white sm:text-7xl">
          {{ title }}
        </h2>
        <p
          v-if="description"
          class="mx-auto mt-8 max-w-4xl text-base font-medium leading-relaxed text-white/50 lg:text-xl"
        >
          {{ description }}
        </p>

        <div class="mt-14 flex flex-col items-center justify-center gap-4 sm:flex-row sm:gap-5">
          <UiButton
            :to="primaryTo"
            variant="white"
            size="md"
