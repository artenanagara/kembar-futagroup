...
const description = 'Daftar unit bisnis Kembar Futago Group di bidang manufaktur, logam, teknik, lansekap, dan solusi industri.'
...
<template>
  <div>
      ...
      <div class="relative z-10 mx-auto flex min-h-[500px] max-w-[1440px] items-end px-5 pb-14 pt-28 sm:px-8 lg:px-20">
        <div class="max-w-3xl">
          ...
          <p class="mt-5 max-w-2xl text-base leading-relaxed text-white/80">
            Ekosistem usaha yang saling terhubung untuk memperkuat manufaktur, teknik, produk ruang publik, dan solusi industri.
          </p>
        </div>
      </div>
    </section>
    ...
    <LayoutSiteFooter
      title="Jelajahi produk dan solusi kami."
      primary-label="Produk & Solusi"
