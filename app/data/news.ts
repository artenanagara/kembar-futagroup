export const newsHero = {
  ...
  description: 'Cerita, perkembangan, dan kabar terbaru dari ekosistem Kembar Futa Group.',
...
export const newsPosts: NewsPost[] = [
  ...
  },
  {
    ...
    title: 'Perluas Pasar, Produk Kembar Futa Group Kini Diekspor ke Singapura',
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Setelah bertahun-tahun melayani pasar domestik, produk manufaktur Kembar Futa Group kini mulai menjangkau pasar ekspor, termasuk Singapura dan Timor Leste. Langkah ini menjadi tonggak penting dalam perjalanan grup sebagai holding manufaktur yang berakar dari Klaten.' },
      { type: 'heading', text: 'Langkah Awal Menuju Pasar Regional' },
      { type: 'paragraph', text: 'Setelah bertahun-tahun melayani pasar domestik, produk manufaktur Kembar Futa Group kini mulai menjangkau pasar ekspor, termasuk Singapura dan Timor Leste. Langkah ini menjadi tonggak penting dalam perjalanan grup sebagai holding manufaktur yang berakar dari Klaten.' },
      { type: 'heading', text: 'Langkah Awal Menuju Pasar Regional' },
      { type: 'paragraph', text: 'Setelah bertahun-tahun melayani pasar domestik, produk manufaktur Kembar Futa Group kini mulai menjangkau pasar ekspor, termasuk Singapura dan Timor Leste. Langkah ini menjadi tonggak penting dalam perjalanan grup sebagai holding manufaktur yang berakar dari Klaten.' },
  ...
  },
  {
    ...
    title: 'Kembar Futa Group Raih Sertifikasi Standar Mutu Produksi',
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Sebagai bagian dari komitmen menjaga mutu produk, Kembar Futa Group berhasil meraih sertifikasi standar mutu produksi untuk unit usaha manufaktur dan permesinannya.' },
  ...
  },
  {
    ...
    title: 'Kembar Futa Group Dukung Pembangunan Infrastruktur IKN',
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Kembar Futa Group turut berkontribusi dalam pembangunan Ibu Kota Nusantara (IKN) melalui penyediaan produk infrastruktur, utilitas kawasan, dan elemen ruang publik.' },
  ...
  },
  {
    ...
    title: 'Program CSR: Kembar Futa Group Latih Warga Klaten Keahlian Las',
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Sebagai bagian dari program tanggung jawab sosial perusahaan, Kembar Futa Group menggelar pelatihan keahlian teknik las bagi warga di sekitar fasilitas produksi di Klaten.' },
  ...
  },
  {
    ...
    title: 'Kembar Futa Group Buka Program Magang Engineering 2026',
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Kembar Futa Group membuka program magang engineering bagi mahasiswa aktif yang tertarik mempelajari proses produksi manufaktur secara langsung di lapangan.' },
