...
export const visionMission = {
  vision: {
    label: 'Visi',
    title: 'Menjadi grup manufaktur paling terpercaya di Indonesia.',
    description: 'Sebuah grup yang dikenang karena mutu cor logamnya, ketepatan mesinnya, dan kontribusinya membentuk ruang publik bangsa.'
  },
  mission: {
    label: 'Misi',
    title: 'Tumbuh sebagai holding industri yang andal dan bermanfaat bagi semua.',
    description: 'Kami berinvestasi pada manusia, mesin, dan sistem agar setiap perusahaan anggota tumbuh kuat, mandiri, dan saling memperkuat.'
  },
  principles: [
    {
      title: 'Integritas',
      description: 'Sistem kerja yang efektif, tepat guna, dan menjunjung etika bisnis.'
    },
    {
      title: 'Inovasi',
      description: 'Produk logam, permesinan, dan turunannya yang inovatif dan berkelanjutan.'
    },
    {
      title: 'Kemitraan',
      description: 'Kemitraan strategis yang saling menguntungkan demi layanan pelanggan prima.'
    },
    {
      title: 'Manfaat',
      description: 'Meningkatkan nilai perusahaan demi manfaat semua kepentingan.'
    }
  ]
}
...
export const companyValues = [
  {
    ...
    title: 'Sinergi',
    description: 'Kami bekerja sebagai satu grup. Kekuatan satu unit menjadi kekuatan unit lain.'
  },
  {
    icon: 'i-lucide-crosshair',
    title: 'Presisi',
    description: 'Ketelitian bukan target akhir, tapi kebiasaan dari merancang hingga finishing.'
  },
  {
    icon: 'i-lucide-book-open-check',
    title: 'Pembelajaran',
    description: 'Kami tidak merasa cukup. Setiap proyek jadi bahan memperbaiki cara kerja.'
  },
  {
    icon: 'i-lucide-hand-heart',
    title: 'Kebermanfaatan',
    description: 'Kami mengukur keberhasilan dari manfaat yang dirasakan orang lain.'
  }
]
...
export const groupStructureItems = [
  ...
  },
  {
    ...
    title: 'Ayam Tentrem Logam, Futake, Futago Karya',
    description: 'Pengecoran, fabrikasi, dan produk utilitas untuk kebutuhan proyek dan ruang publik.'
  },
  {
    label: 'Teknik & Produksi',
    title: 'Kembar Teknika',
    description: 'Perancangan mesin, komponen teknis, dan dukungan engineering produksi.'
  },
  {
    label: 'Produk & Lansekap',
    title: 'Zwilling, Tvilling',
    description: 'Pengembangan produk ruang luar, elemen lansekap, dan solusi visual-fungsional.'
  }
]
